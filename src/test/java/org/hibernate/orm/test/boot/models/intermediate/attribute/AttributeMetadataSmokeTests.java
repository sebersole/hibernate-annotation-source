...
import org.hibernate.orm.test.boot.models.CompositeUserTypeImpl;
import org.hibernate.orm.test.boot.models.EmbeddableInstantiatorImpl;
import org.hibernate.orm.test.boot.models.MapConverter;
import org.hibernate.orm.test.boot.models.ModelHelper;
import org.hibernate.orm.test.boot.models.UserTypeImpl;
...
import static org.hibernate.boot.models.intermediate.spi.AttributeMetadata.AttributeNature.ANY;
import static org.hibernate.boot.models.intermediate.spi.AttributeMetadata.AttributeNature.BASIC;
import static org.hibernate.boot.models.intermediate.spi.AttributeMetadata.AttributeNature.EMBEDDED;
import static org.hibernate.boot.models.intermediate.spi.AttributeMetadata.AttributeNature.PLURAL;
import static org.hibernate.boot.models.intermediate.spi.AttributeMetadata.AttributeNature.TO_ONE;
...
public class AttributeMetadataSmokeTests {
	...
	void testClassifications(ServiceRegistryScope scope) {
		...
		final ModelProcessingContext processingContext = ModelHelper.buildProcessingContext( registry );
